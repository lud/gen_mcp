...
* `:extensions` - A list `Extension` implementations to add more tools, resource repositories and prompt repositories. List items can be either module names, `{module, arg}` tuples or a descriptor map. The default value is `[]`.
